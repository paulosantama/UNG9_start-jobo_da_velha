...
export class JogoDaVelhaService {
  ...
  private _modoJogo: ModoJogo;

  constructor() {
    this._modoJogo = ModoJogo.SINGLE_PLAYER;
  }
  ...
  set modoJogo(value: ModoJogo) {
    this._modoJogo = value;
  }

  get modoJogo(): ModoJogo {
  ...
  jogar(posX: number, posY: number): void {
    ...
    if (this._modoJogo == ModoJogo.SINGLE_PLAYER) {
