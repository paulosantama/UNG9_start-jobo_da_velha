...
import { JogoDaVelhaService, ModoJogo } from './shared';
...
export class JogoDaVelhaComponent implements OnInit {
  ...
  /**
   * Retorna se o final deve ser exibido
   *
   * @return boolean
   */
  ...
  setModePlayer(modoJogo: ModoJogo) {
    this.jogoDaVelhaService.modoJogo = modoJogo;
  }

  getModePlayer(): ModoJogo {
    return this.jogoDaVelhaService.modoJogo
  }
}
